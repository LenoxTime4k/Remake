...
public class IntercambioJpaController implements Serializable {
    ...
    public IntercambioJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void edit(Intercambio intercambio) throws IllegalOrphanException, NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
